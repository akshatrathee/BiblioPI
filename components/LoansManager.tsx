...
export const LoansManager: React.FC<LoansManagerProps> = ({ state, onUpdateState }) => {
    ...
    return (
        <div className="p-6 h-full flex flex-col animate-fade-in pb-24">
            ...
            {/* Intro Pill */}
            <div className="mb-8 p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl flex items-start gap-4 animate-fade-in-up">
                <span className="material-symbols-outlined text-emerald-400">info</span>
                <p className="text-xs font-medium text-slate-300 leading-relaxed">
                    Books are automatically marked as <span className="text-white font-bold">overdue after 30 days</span>. Remind borrowers to return items to keep your inventory accurate.
                </p>
            </div>
